                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            InkWell(onTap: () async {
                                              ...
                                              myDialog(context, AppImages.done, "OTP Sent Successfully!","Okay", bheight*0.4, twidth*0.4);
                                              setState(() {
              ...
              children: [
                Expanded(
                  child: Padding(
                    ...
                    child: OutlinedButton(onPressed: press, child: Text("${buttonText}",style: TextStyle(color: ThemeColor.primary),)),
                  ),
                ),
              ],
            )
